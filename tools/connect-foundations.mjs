...
const links={
  ...
  'PHY101.measurement':[['units','Units: convert and check dimensions'],['notation','Numerical: keep powers of ten and precision']],
  'PHY101.motion':[['vectors','Conceptual: keep velocity direction'],['graphs','Graphical: position and velocity slopes']],
  'PHY101.forces':[['vectors','Conceptual: choose axes and add signed components'],['trigonometry','Numerical: resolve a force from its stated angle']],
