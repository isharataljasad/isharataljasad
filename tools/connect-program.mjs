...
for(const file of pages){
 let html=read(file);
 if(file.startsWith('semester-1/')&&!html.includes('href="/semester-1/coverage/"')) html=html.replace('</nav><span class="semester">','<a href="/semester-1/coverage/">Semester lessons</a></nav><span class="semester">');
