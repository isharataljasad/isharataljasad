...
for(const term of ['المنهج','مسار الكتب','Educator','Pearson+','14 أسبوعًا','33 مفهومًا','مرحلة حصر المصادر']) assert.ok(html.includes(term),`missing ${term}`);
...
console.log('MA 101 checks passed: syllabus visible, independent sources, 33 concepts, 1985 reading minutes.');
