...
export function classifyFeedback(value){
 ...
 if(value==='repeated-output')return {correct:false,message:'You found a repeated output, 6. Follow the input instead: input 1 gives 6 and input 3 also gives 6. Neither input has two outputs. Re-read the input-column rule above, then try again; the link below opens a fuller explanation.'};
